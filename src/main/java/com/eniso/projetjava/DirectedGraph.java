...
public class DirectedGraph extends Graph {
    ...
    private List<Integer> directedEdges;

    public DirectedGraph(List<Integer> vertices, Map<Integer, List<Integer>> edges, List<Integer> directedEdges) {
        super(vertices, edges);
        this.directedEdges = directedEdges;
    }

    public List<Integer> getDirectedEdges() {
        return directedEdges;
    }

    public void setDirectedEdges(List<Integer> directedEdges) {
        this.directedEdges = directedEdges;
    }
