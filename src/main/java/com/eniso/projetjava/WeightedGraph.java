...
public class WeightedGraph extends Graph {
    ...
    private Map<Integer, Map<Integer, Integer>> weights; // Ou Map<Integer, List<Integer>> selon la représentation souhaitée
    
    public WeightedGraph(List<Integer> vertices, Map<Integer, List<Integer>> edges, Map<Integer, Map<Integer, Integer>> weights) {
        super(vertices, edges);
        this.weights = weights;
    }
    
    public Map<Integer, Map<Integer, Integer>> getWeights() {
        return weights;
    }
    
    public void setWeights(Map<Integer, Map<Integer, Integer>> weights) {
        this.weights = weights;
    }
